...
OBJS= \
  ...
  SatelliteSensor.obj \
  CommunicationUnit.obj \
  DataProcessingUnit.obj \
  SensingSystemPKG.obj \
...
UnderWaterSensor.obj : UnderWaterSensor.cpp UnderWaterSensor.h    SensingSystemPKG.h SMSTWDMain.h double_seismicVibration_ProxyFlowPropertyInterface.h double_waterPressure_ProxyFlowPropertyInterface.h RhpString_flowDirection_ProxyFlowPropertyInterface.h bool_transmissionMode_ProxyFlowPropertyInterface.h 
	$(CREATE_OBJ_DIR)
...
CommunicationUnit.obj : CommunicationUnit.cpp CommunicationUnit.h    SensingSystemPKG.h DataProcessingUnit.h float_currentRiskScore_ProxyFlowPropertyInterface.h float_waterPressureInference_ProxyFlowPropertyInterface.h float_stormIntensityInference_ProxyFlowPropertyInterface.h float_seismicInference_ProxyFlowPropertyInterface.h int_targetRegionCoordinates_ProxyFlowPropertyInterface.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"CommunicationUnit.obj" "CommunicationUnit.cpp" 



DataProcessingUnit.obj : DataProcessingUnit.cpp DataProcessingUnit.h    SensingSystemPKG.h CommunicationUnit.h float_currentRiskScore_ProxyFlowPropertyInterface.h float_waterPressureInference_ProxyFlowPropertyInterface.h float_stormIntensityInference_ProxyFlowPropertyInterface.h float_seismicInference_ProxyFlowPropertyInterface.h int_targetRegionCoordinates_ProxyFlowPropertyInterface.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"DataProcessingUnit.obj" "DataProcessingUnit.cpp" 



SensingSystemPKG.obj : SensingSystemPKG.cpp SensingSystemPKG.h    SMSTWDMain.h AerialSensor.h UnderWaterSensor.h SatelliteSensor.h CommunicationUnit.h DataProcessingUnit.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"SensingSystemPKG.obj" "SensingSystemPKG.cpp" 



ProxyPortInterfaces.obj : ProxyPortInterfaces.cpp ProxyPortInterfaces.h    double_seismicVibration_ProxyFlowPropertyInterface.h double_waterPressure_ProxyFlowPropertyInterface.h RhpString_flowDirection_ProxyFlowPropertyInterface.h bool_transmissionMode_ProxyFlowPropertyInterface.h double_windSpeed_ProxyFlowPropertyInterface.h double_precipitationAmount_ProxyFlowPropertyInterface.h double_stormPosition_ProxyFlowPropertyInterface.h RhpString_windDirection_ProxyFlowPropertyInterface.h double_ImageData_ProxyFlowPropertyInterface.h double_stormCoordinates_ProxyFlowPropertyInterface.h float_currentRiskScore_ProxyFlowPropertyInterface.h float_waterPressureInference_ProxyFlowPropertyInterface.h float_stormIntensityInference_ProxyFlowPropertyInterface.h float_seismicInference_ProxyFlowPropertyInterface.h int_targetRegionCoordinates_ProxyFlowPropertyInterface.h 
	$(CREATE_OBJ_DIR)
...
clean:
	@echo Cleanup
	if exist SMSTWDMain.obj erase SMSTWDMain.obj
	if exist AerialSensor.obj erase AerialSensor.obj
	if exist UnderWaterSensor.obj erase UnderWaterSensor.obj
	if exist SatelliteSensor.obj erase SatelliteSensor.obj
	if exist CommunicationUnit.obj erase CommunicationUnit.obj
	if exist DataProcessingUnit.obj erase DataProcessingUnit.obj
	if exist SensingSystemPKG.obj erase SensingSystemPKG.obj
